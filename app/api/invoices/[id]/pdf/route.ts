...
async function loadAssets() {
  try {
    ...
    const plasmaLogo = await getBase64File("public/plasma-dark.svg");
    console.log("[loadAssets] Successfully loaded Plasma logo");

    return { montserrat, plasmaLogo };
  } catch (error) {
          ...
          <div class="container">
            <div class="invoice-header">
              <div class="logo-section">
                <img 
                  src="data:image/svg+xml;base64,${assets.plasmaLogo}" 
                  alt="Plasma"
                  class="logo"
                />
              </div>
            ...
            <div class="footer">
              This invoice was generated by Plasma, a decentralized invoicing platform.
            </div>
          </div>
        </body>
      </html>
